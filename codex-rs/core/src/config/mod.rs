...
pub(crate) const DEFAULT_COMPACT_PRESERVE_TURNS: u32 = 5;
...
pub struct Config {
    ...
    /// Compaction projection strategy.
    pub compact_mode: CompactMode,

    /// Number of recent turns to preserve verbatim in collapse compaction mode.
    pub compact_preserve_turns: u32,
...
impl Config {
    ...
    pub(crate) fn load_config_with_layer_stack(
        ...
        let compact_preserve_turns = cfg
            .compact_preserve_turns
            .unwrap_or(DEFAULT_COMPACT_PRESERVE_TURNS);
