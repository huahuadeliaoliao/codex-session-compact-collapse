...
use crate::compact_session::run_inline_session_auto_compact_task;
...
async fn run_auto_compact(
    ...
    match select_compact_route(turn_context.compact_strategy, turn_context.provider.info()) {
        CompactRoute::Session => {
            run_inline_session_auto_compact_task(
                Arc::clone(sess),
                Arc::clone(turn_context),
