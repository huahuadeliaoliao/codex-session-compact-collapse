use super::*;
use crate::compact_session::CompactRoute;
use crate::compact_session::select_compact_route;
...
#[test]
fn select_compact_route_uses_remote_then_local_for_default_strategy() {
    ...
    assert_eq!(
        CompactRoute::Remote,
        select_compact_route(CompactStrategy::Default, &remote_provider)
    );
    assert_eq!(
        CompactRoute::Local,
        select_compact_route(CompactStrategy::Default, &local_provider)
    );
}
